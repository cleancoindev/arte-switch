        ...
        return (
            <section>
                <section className="ExpTop">
                    ...
                    <section className="ExpPar">
                        <p><a href={window.context.switchWebsite} target="_blank">{window.context.switchWebsite}</a> is an easy procedure to receive new ${window.newToken.symbol} V3 Voting tokens, by burning old one ${window.oldToken.symbol} V1/V2 tokens.</p>
                    </section>
                    <section className="ExpPar">
                        <p>To receive your ${window.newToken.symbol} V3 tokens—burning your ${window.oldToken.symbol} V1 tokens in the process—all you need to do is navigate to the "Switch" section of this site, and follow these steps:  </p>
                    </section>
                    <section className="ExpPar">
                        <p>#1 Set the amount of ${window.oldToken.symbol} V1/V2 you wish to switch.</p>
                        ...
                        <p>#6 You’re done! Just wait for the Ethereum Transaction to complete, and the ${window.newToken.symbol} V3 tokens will be in your wallet!</p>
                    </section>
                    <h2>Incentives</h2>
                    <section className="ExpPar">
                    ...
                    <section className="ExpPar">
                        <p><b>Disclamer:</b> ${window.oldToken.symbol} V1/V2 will not be supported by the {window.newToken.name} team after August 15 2020.</p>
                    </section>
                    <section className="ExpPar">
                        <p><b>Disclamer:</b> Switching ${window.oldToken.symbol} V1/V2 to ${window.newToken.symbol} V3 is an irreversible action. Do it at your own risk.</p>
                    </section>
                </section>
            </section>
        );
